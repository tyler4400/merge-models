...
export const TIERS: readonly Tier[] = [
  { id: 1, name: "豆包", radius: 0.60, mass: 0.55, iconUrl: icon01, tint: [1, 0.42, 0.08] },
  { id: 2, name: "元宝", radius: 0.75, mass: 0.85, iconUrl: icon02, tint: [1, 0.7, 0.1] },
  { id: 3, name: "Qwen", radius: 0.93, mass: 1.3, iconUrl: icon03, tint: [0.42, 0.18, 1] },
  { id: 4, name: "Kimi", radius: 1.14, mass: 1.95, iconUrl: icon04, tint: [0.05, 0.78, 0.98] },
  { id: 5, name: "DeepSeek", radius: 1.38, mass: 2.9, iconUrl: icon05, tint: [0.12, 0.42, 1] },
  { id: 6, name: "Gemini", radius: 1.62, mass: 4.2, iconUrl: icon06, tint: [0.2, 0.55, 1] },
  { id: 7, name: "Grok", radius: 1.88, mass: 6.1, iconUrl: icon07, tint: [0.55, 0.58, 0.7] },
  { id: 8, name: "ChatGPT", radius: 2.20, mass: 8.6, iconUrl: icon08, tint: [0.08, 0.78, 0.55] },
  { id: 9, name: "Claude", radius: 2.45, mass: 12, iconUrl: icon09, tint: [1, 0.38, 0.12] },
  { id: 10, name: "T-800", radius: 2.75, mass: 18, iconUrl: icon10, tint: [0.85, 0.18, 0.12] },
];
